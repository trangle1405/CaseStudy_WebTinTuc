                            ...
                            <div class="row-item row">
                                <h3>
                                    ...
                                    @foreach($cate->TypeOfNews as $typeOfNews)
                                        <small><a href="category/{{$typeOfNews->id}}/{{ $typeOfNews->name_slug.".html" }}"><i>{{ $typeOfNews->name }}</i></a>/</small>
                                    @endforeach
                                </h3>
                                <?php
                                ...
                                <div class="col-md-8 border-right">
                                    ...
                                    <div class="col-md-7">
                                        <h3><a href="news/{{$news_one['id']}}/{{ $news_one['title_slug'] }}.html">{{ $news_one['title'] }}</a></h3>
                                        <p>{!! $news_one['summary'] !!}</p>
                                        <a class="btn btn-primary" href="news/{{$news_one['id']}}/{{ $news_one['title_slug'] }}.html">Xem Thêm <span class="glyphicon glyphicon-chevron-right"></span></a>
                                    </div>
