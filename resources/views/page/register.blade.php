				...
				<div class="panel-body">
					...
					<form method="POST" action="register">
						...
						<div>
							...
							<input type="text" class="form-control" placeholder="Nhập tên của bạn" name="name" value="{{old('name')}}" aria-describedby="basic-addon1">
						</div>
						<br>
						<div>
							<label>Địa Chỉ Email</label>
							<input type="email" class="form-control" placeholder="Nhập Địa Chỉ Email" name="email" value="{{old('email')}}"  aria-describedby="basic-addon1"
							>
						</div>
						<br>	
						<div>
