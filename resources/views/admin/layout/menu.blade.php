<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="admin/news/list"><i class="fa fa-newspaper-o fa-fw icon-mright"></i>Tin Tức<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="admin/user/list"><i class="fa fa-users fa-fw icon-mright"></i>Quản lý Người Dùng<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
