                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    ...
                    <form action="admin/user/add" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control input-width" type="text" name="name" placeholder="Nhập tên người dùng" value="{{ old('username') }}" />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input name="level" value="0" checked="" type="radio">Khach
                            </label>
                            <label class="radio-inline">
